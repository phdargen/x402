...
- Response shape / `withX402` usage: `examples/typescript/templates/next/app/api/weather/route.ts`
- Batch-settlement Express example wiring: `examples/typescript/scripts/servers/http/schemes/batch-settlement.ts/index.ts`
- Batch-settlement client: `examples/typescript/scripts/clients/http/schemes/batch-settlement.ts`
