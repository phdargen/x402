...
cd x402/examples/typescript/templates/cloudfront-lambda-edge/lambda
```
...
Use the [`fetch` client example](../../../../scripts/clients/http/fetch.ts) from this repo to make a paid request:
