...
const baseConfig = {
  entry: {
    ...
    "batch-settlement/facilitator/file-storage": "src/batch-settlement/facilitator/fileStorage.ts",
    "batch-settlement/facilitator/redis-storage":
      "src/batch-settlement/facilitator/redisStorage.ts",
