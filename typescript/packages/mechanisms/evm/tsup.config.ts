...
const baseConfig = {
  entry: {
    ...
    "upfront/client/index": "src/upfront/client/index.ts",
    "upfront/server/index": "src/upfront/server/index.ts",
    "upfront/facilitator/index": "src/upfront/facilitator/index.ts",
