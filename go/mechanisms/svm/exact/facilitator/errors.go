...
const (
	...
	ErrSmartWalletFeePayerNotIsolated       = "smart_wallet_fee_payer_not_isolated"
	ErrSmartWalletMalformedComputeBudget    = "smart_wallet_malformed_compute_budget"
	ErrSmartWalletMalformedComputeLimit     = "smart_wallet_malformed_compute_limit"
	ErrSmartWalletMalformedComputePrice     = "smart_wallet_malformed_compute_price"
	ErrSmartWalletComputeUnitsTooHigh       = "smart_wallet_compute_units_too_high"
	ErrSmartWalletPriorityFeeTooHigh        = "smart_wallet_priority_fee_too_high"
	ErrSmartWalletUnsupportedComputeBudget  = "smart_wallet_unsupported_compute_budget_instruction"
	ErrSmartWalletAltResolutionUnavailable  = "smart_wallet_alt_resolution_not_available"
	ErrSmartWalletVerificationUnavailable   = "smart_wallet_verification_not_available"
	ErrSmartWalletSimulationFailed          = "smart_wallet_simulation_failed"
	ErrSmartWalletCannotDeriveATA           = "smart_wallet_cannot_derive_destination_ata"
	ErrSmartWalletNoTransferInSimulation    = "smart_wallet_no_transfer_in_simulation"
	ErrSmartWalletTransferMismatch          = "smart_wallet_transfer_mismatch"
	ErrSmartWalletMultipleMatchingTransfers = "smart_wallet_multiple_matching_transfers"
	ErrSmartWalletProgramNotAllowed         = "smart_wallet_program_not_allowed"
)
