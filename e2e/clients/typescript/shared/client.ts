...
export async function createE2EClient(): Promise<E2EClientContext> {
  ...
  // signer (CLIENT_EVM_VOUCHER_SIGNER_PRIVATE_KEY) exercises the alt-EOA voucher branch
  ...
  const batchSettlementPhase = process.env.BATCH_SETTLEMENT_PHASE as BatchSettlementPhase | undefined;
