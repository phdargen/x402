...
def create_e2e_client() -> ClientContext:
    """Build a configured x402Client with e2e scheme registrations."""
    ...
    voucher_signer_key = os.getenv("CLIENT_EVM_VOUCHER_SIGNER_PRIVATE_KEY")
